...
| **Reach-and-Farm** | Reward↑ reached%↓ after step 4K, stop_bonus climbs | stop_bonus×remaining_steps >> navigation reward (20.8× ratio) | Time-cap stop_bonus (50-step budget via Round7 fix) |
